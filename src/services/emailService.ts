...
export const sendAutoResponse = async (
  ...
  const templateParams = {
    ...
    submission_time: new Date().toLocaleString(),
    closing_message: 'Thank you for choosing Smart Track. For a tailored solution, like asset tracking, personnel trackers, guard patrols, vessel tracking, email us on info@terunapng.com for more information.',
